...
def randomNeighbour(blueprint, solution: list):          # can return an infeasable solution
    ...
    print("e")
    if (blueprint.atGrid(neighbour[routerChange]) == "#"): return None, None
    if (checkSolutionDuplicates(solution)): return None, None
    neighbourValue = value(blueprint, neighbour)
    if neighbourValue == None: return None, None
...
def hillClimbing(blueprint, solution):
    ...
    while True:
        ...
        if (neighbour == None and neighbourValue == None): continue
        break
    ...
    while routersPlaced(neighbour) > blueprint.getMaxRouters()/10:
        while iteration < 100:
            ...
            iteration += 1
            if (neighbourCandidate == None and neighbourCandidateValue == None): continue
